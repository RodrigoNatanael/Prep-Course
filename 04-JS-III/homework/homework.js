...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  var largoarray = resultadostest.lenght
var suma = 0
...
if(srguments.lenght <1) return 0;
...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí  
  for(var i = 1; i < arreglo.leght; i++)
if arreglo [0] === arreglo [1]n{
return true;
}
return false;
}
